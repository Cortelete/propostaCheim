  ...
  return (
    <div className="animated-gradient-bg text-gray-200 min-h-screen">
      ...
      <Modal isOpen={modalContent !== null} onClose={closeModal}>
        {modalContent && (
          <>
            <h3 className="text-2xl font-bold text-white mb-4">{modalContent.title}</h3>
      ...
      <a
        ...
        className="fixed bottom-6 right-6 bg-green-500 text-white p-4 rounded-full shadow-lg hover:bg-green-600 hover:scale-110 transition-all duration-300 z-50 flex items-center justify-center animate-pulse group"
