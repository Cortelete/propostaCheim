      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start">
             <div className="flex items-center gap-2 text-white text-base sm:text-xl font-bold">
          ...
          {/* Contatos */}
          <div>
            <h4 className="font-semibold text-white tracking-wider uppercase text-sm">Contato</h4>
          ...
          <div className="flex flex-col items-center md:items-end justify-center">
             <button
              onClick={scrollToTop}
              className="flex items-center gap-2 text-gray-400 hover:text-[#FFD369] transition-colors duration-300 text-xs sm:text-sm"
            >
              Voltar ao topo <ArrowUpIcon className="w-4 h-4 sm:w-5 sm:h-5" />
            </button>
          </div>
        </div>
        <div className="mt-10 sm:mt-12 border-t border-gray-800/50 pt-6 sm:pt-8 text-center text-xs sm:text-sm text-gray-500">
