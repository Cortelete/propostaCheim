...
const ProposalSection: React.FC<ProposalSectionProps> = ({ section, onOpenModal }) => {
                ...
                <li key={index}>
                  <div className="p-4 bg-amber-900/20 border border-amber-400/30 rounded-xl">
                    <div className="flex items-start gap-4 mb-4">
                      ...
                      <div>
                        <p className="font-bold text-lg text-amber-300">{benefit.text}</p>
            ...
            return (
              <li key={index} className="flex items-start gap-3 p-3 bg-gray-800/50 rounded-lg">
                ...
                <div className="flex-grow">
                  ...
                  {benefit.details && <p className="text-sm text-gray-400 mt-1">{benefit.details}</p>}
                  {benefit.subItems && (
                    <ul className="mt-2 space-y-1 list-disc list-inside text-gray-400 text-sm">
  ...
  return (
    <div
      ...
      className="bg-[#1a1a1a] border border-gray-800 rounded-2xl p-6 flex flex-col h-full transform hover:scale-[1.02] hover:border-gray-700 transition-all duration-300 shine-effect cursor-pointer group"
    >
              ...
              <div className="flex-grow">
                ...
                {benefit.details && (
                  <button
                    ...
                    className="ml-2 text-gray-500 hover:text-white transition-colors duration-200 z-10 relative"
      ...
      <div className="mt-8">
        <div className={`${section.bgColor} w-full text-black font-bold py-3 px-6 rounded-lg uppercase tracking-wider text-center group-hover:brightness-110 group-hover:shadow-lg group-hover:shadow-white/10 transform group-hover:scale-105 transition-all duration-300`}>
